	...
	library.scheme.validate(query, {
		...
		async.eachSeries(transactions, function (item, cb) {
			...
			modules.accounts.getAccount({
                ...
                var multisignatures = sender.u_multisignatures || [];
				if ((sender.publicKey == query.publicKey && multisignatures.length > 0) || multisignatures.indexOf(query.publicKey) >= 0 || multisignatures.indexOf(query.publicKey) >= 0) {
